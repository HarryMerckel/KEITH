...
# 'Obstacle Course' for KEITH at PiWars
...
while True:
    ...
    # If Plus and Minus buttons pressed together then rumble, turn off all LEDs and quit.
    ...
    #  accordingly, restarting the loop so nothing strange happens.
    
    # Two speed options have been set using the up and down buttons to switch between them.
    ...
    if (buttons & cwiid.BTN_UP):
        ...
        # The rate of turning changes depending on whether the KEITH is moving or not.
        motor(0-speed,speed)
        time.sleep(button_delay)
        continue
